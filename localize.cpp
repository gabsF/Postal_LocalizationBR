...
////////////////////////////////////////////////////////////////////////////////
	...
	extern char g_pszMainMenu_Start[]							= "JOGAR";
	extern char g_pszMainMenu_Options[]							= "OPCOES";
	extern char g_pszMainMenu_Editor[]							= "EDITOR";
	extern char g_pszMainMenu_Buy[]								= "INFO. DE COMPRA";
	extern char g_pszMainMenu_Exit[]								= "SAIR";

	extern char g_pszVerifyExitMenu_Title[]					= "QUER SAIR?";
	extern char g_pszVerifyExitMenu_Yes[]						= "SIM";
	extern char g_pszVerifyExitMenu_No[]						= "NAO";

	extern char g_pszVerifyQuitMenu_Title[]					= "QUER DESISTIR?";
	extern char g_pszVerifyQuitMenu_Yes[]						= "SIM";
	extern char g_pszVerifyQuitMenu_No[]						= "NAO";

	extern char g_pszGameMenu_Title[]							= "JOGO";
	extern char g_pszGameMenu_Continue[]						= "CONTINUAR";
	extern char g_pszGameMenu_Save[]								= "SALVAR";
	extern char g_pszGameMenu_Options[]							= "OPCOES";
	extern char g_pszGameMenu_Quit[]								= "DESISTIR";

	extern char g_pszEditorMenu_Title[]							= "EDITOR";
	extern char g_pszEditorMenu_Continue[]						= "CONTINUAR";
	extern char g_pszEditorMenu_Options[]						= "OPCOES";
	extern char g_pszEditorMenu_Quit[]							= "SAIR";

	extern char g_pszOptionsMenu_Title[]						= "OPCOES";
...
#endif
	extern char g_pszDifficultyMenu_Title[]					= "DIFICULDADE";
	extern char g_pszDifficultyMenu_SetDifficulty[]			= "DEFINIR";

	extern char g_pszOrganMenu_Title[]							= "TESTE DE SOM";
	extern char g_pszOrganMenu_SpecialKeysHeading[]			= "TECLAS ESPECIAIS";
	extern char g_pszOrganMenu_NumericKeysFunction[]		= "  0 ate 9 - TOQUE UM SOM";
	extern char g_pszOrganMenu_AlphaKeysFunction[]			= "  A ate Z - TOQUE UM SOM";
	extern char g_pszOrganMenu_TabKeyFunction[]				= "  TAB - MUDAR OS SONS";
	extern char g_pszOrganMenu_Exit[]							= "SAIR";

	extern char g_pszAudioMenu_Title[]							= "AUDIO";
	extern char g_pszAudioMenu_Mixer[]							= "MIXER";
	extern char g_pszAudioMenu_SoundTest[]						= "TESTE DE SOM";
	extern char g_pszAudioMenu_Language[]						= "IDIOMA";
	extern char g_pszAudioMenu_PainFrequency[]					= "FREQ. DE DOR";
	...
	extern char g_pszVideoMenu_Gamma[]							= "GAMA";

	extern char g_pszControlsMenu_Title[]						= "CONTROLES";
	extern char g_pszControlsMenu_KeyboardSetup[]			= "CONFIG. DO TECLADO";
	extern char g_pszControlsMenu_MouseSetup[]				= "CONFIG. DO MOUSE";
	extern char g_pszControlsMenu_JoystickSetup[]			= "CONFIG. DO X CONTROLE";
	extern char g_pszControlsMenu_TurningSpeeds[]			= "VELOCIDADE DE GIRAR";
	extern char g_pszControlsMenu_UseMouse[]					= "USAR MOUSE";
	extern char g_pszControlsMenu_ClassicMouse[]			= "MOUSE CLASSICO";	
	extern char g_pszControlsMenu_HorizMouseSensitivity[]	= "SENS. DO MOUSE HORIZ";
	extern char g_pszControlsMenu_VertMouseSensitivity[]	= "SENS. DO MOUSE VERT";

	extern char g_pszKeyboardSetupMenu_Title[]				= "CONFIG. DO TECLADO";

	extern char g_pszMouseSetupMenu_Title[]					= "CONFIG. DO MOUSE";
	...
	extern char g_pszPerformanceMenu_DynamicVolume[]		= "VOLUME DINAMICO";
	extern char g_pszPerformanceMenu_AmbientSounds[]		= "SONS DO AMBIENTE";

	extern char g_pszRotationSetupMenu_Title[]				= "VELOCIDADE DE GIRAR ";
	extern char g_pszRotationSetupMenu_RunningSlow[]		= "CORRENDO (LENTO)";
	extern char g_pszRotationSetupMenu_RunningFast[]		= "CORRENDO (RAPIDO)";
	extern char g_pszRotationSetupMenu_StandingSlow[]		= "PARADO (LENTO)";
	extern char g_pszRotationSetupMenu_StandingFast[]		= "PARADO (RAPIDO)";
	extern char g_pszRotationSetupMenu_TapDegrees[]			= "GRAUS DE TOQUE";
	extern char g_pszRotationSetupMenu_RestoreDefaults[]	= "RESTAURAR PADRAO";
	extern char g_pszRotationSetupMenu_RestoreDefaultsOld[] = "RESTAURAR PADRAO (VELHO)";

	extern char g_pszVolumesMenu_Title[]						= "MIXER DE AUDIO";

	extern char g_pszStartGameMenu_Title[]						= "INICIAR O JOGO";
	extern char g_pszStartGameMenu_SinglePlayer[]			= "UM JOGADOR";
	extern char g_pszStartGameMenu_Multiplayer[]				= "MULTIPLAYER";
	extern char g_pszStartGameMenu_Demo[]						= "DEMO";

	extern char g_pszStartSinglePlayerMenu_Title[]			= "UM JOGADOR";
#if defined(START_MENU_ADDON_ITEM)
	#if TARGET == JAPAN_ADD_ON
		extern char g_pszStartSinglePlayerMenu_New[]			= "ENLOUQUECER NO EUA";
		extern char g_pszStartSinglePlayerMenu_AddOn[]		= "ENLOUQUECER NO JAPAO";
	#elif TARGET == POSTAL_PLUS
		extern char g_pszStartSinglePlayerMenu_New[]			= "NOVO JOGO (TODAS AS FASE)";
		extern char g_pszStartSinglePlayerMenu_AddOn[]		= "FASES DO SPECIAL DELIVERY";
	#elif TARGET == POSTAL_2015
		extern char g_pszStartSinglePlayerMenu_NewCampaign[]	= "NOVA CAMPANHA";
		...
		extern char g_pszStartSinglePlayerMenu_AllLevels[]	= "EXCESS POSTAGE (TODAS AS FASES)";
	#else
		#error Strings must be customized for current TARGET
	#endif
#else
	#if TARGET == SUPER_POSTAL
		extern char g_pszStartSinglePlayerMenu_New[]			= "ENLOUQUECER EM TODOS LUGARES";
	#elif (TARGET == POSTAL_PLUS || TARGET == POSTAL_2015)
		extern char g_pszStartSinglePlayerMenu_New[]			= "NOVO JOGO";
	#else
		#error Strings must be customized for current TARGET
	#endif
#endif
	extern char g_pszStartSinglePlayerMenu_LoadLevel[]		= "SELECIONAR FASE";
	extern char g_pszStartSinglePlayerMenu_LoadGame[]		= "CARREGAR O JOGO";
	extern char g_pszStartSinglePlayerMenu_Challenge[]		= "DESAFIOS";

	extern char g_pszStartChallengeMenu_Title[]				= "DESAFIOS";
	extern char g_pszStartChallengeMenu_Gauntlet[]			= "MANOPLA";
	extern char g_pszStartChallengeMenu_Timed[]				= "CONTRA O TEMPO";
	extern char g_pszStartChallengeMenu_Goal[]				= "META";
	extern char g_pszStartChallengeMenu_Flag[]				= "BANDEIRA";
	extern char g_pszStartChallengeMenu_CheckPoint[]		= "CHECKPOINT";

	extern char g_pszStartMultiplayerMenu_Title[]			= "MULTIPLAYER";
	extern char g_pszStartMultiplayerMenu_Join[]				= "JUNTAR-SE AO JOGO";
	extern char g_pszStartMultiplayerMenu_Host[]				= "HOSPEDAR O JOGO";
	extern char g_pszStartMultiplayerMenu_Options[]			= "OPCOES";


	extern char g_pszJoinGameMenu_Title[]						= "JUNTAR-SE AO JOGO";
	extern char g_pszJoinGameMenu_Browse[]						= "NAVEGAR (APENAS LOCAL)";
	extern char g_pszJoinGameMenu_ConnectTo[]					= "CONECTAR AO";

	extern char g_pszHostGameMenu_Title[]						= "HOSPEDAR O JOGO";
	extern char g_pszHostGameMenu_Start[]						= "INICIAR";

	extern char g_pszStartDemoMenu_Title[]						= "DEMO";
	extern char g_pszStartDemoMenu_Browse[]					= "NAVEGAR";
	extern char g_pszStartDemoMenu_Play[]						= "JOGAR";
	extern char g_pszStartDemoMenu_Record[]					= "GRAVAR";
	extern char g_pszStartDemoMenu_ConSite[]				= "CONSTRUCAO";
	extern char g_pszStartDemoMenu_Home[]					= "CASA";
	extern char g_pszStartDemoMenu_Bridge[]					= "PONTE";

	extern char g_pszMultiplayerSetupMenu_Title[]			= "MULTIPLAYER";
	extern char g_pszMultiplayerSetupMenu_Name[]				= "NOME";
	extern char g_pszMultiplayerSetupMenu_Color[]			= "COR DA JAQUETA";
	extern char g_pszMultiplayerSetupMenu_Protocol[]		= "PROTOCOLO";
	extern char g_pszMultiplayerSetupMenu_Connection[]		= "CONEXAO";

	// Keep at end -- was not in original localizable text.
	extern char g_pszControlsMenu_UseJoystick[]				= "USAR X CONTROLE";
...
extern char* g_apszScoreDisplayText[CRealm::TotalScoringModes] = 
	...
	" Relogio %d:%2.2d    Voce tem %d bandeiras    Bandeiras restantes %d",						// Checkpoint
	"Tempo Restante %d:%2.2d",																		// MPTimed
	"Tempo Restante %d:%2.2d",																		// MPFrag
	"",																									// MPLastMan,
	"",																									// MPCaptureFlag
	"",																									// MPTimedFlag,
	"",																									// MPTimedFrag
...
extern char* g_apszScoreGoalText[CRealm::TotalScoringModes] = 
	{
	"      Voce deve matar %d%% dos hostis",												// Standard
	" Mate as pessoas o mais rapido possivel, antes que o tempo acabe.",							// Timed
	" Mate todo mundo antes que o tempo acabe.",													// TimedGoal
	" Capture a bandeira antes que o tempo acabe.",												// TimedFlag
	" Mate %d pessoas no menor tempo possivel.",										// Goal
	" Capture a bandeira no menor tempo possivel.",									// CaptureFlag
	" Pegue o maior numero possivel de bandeiras antes que o tempo acabe.",								// Checkpoint
	" O jogador com alta contagem de corpos quando o tempo acabar sera o vencedor.",				// MPTimed
	" O primeiro jogador que conseguir %d vitimas sera o vencedor.",													// MPFrag
	"",																									// MPLastMan,
	"",																									// MPCaptureFlag
	"",																									// MPTimedFlag
	" Tenta alcancar %d vitimas antes que o tempo acabe",											// MPTimedFrag
	"",																									// MPLastManFrag
	"",																									// MPLastManTimed
	" Nao tem limite de tempo ou de vitimas nesta partida - jogue a vontade"	// MPLastManTimedFrag 
...
extern char* g_apszScoreUnits[]	=
		...
		"",				// Goal.
		"",				// Capture the flag.
		"Bandeiras",			// Checkpoint.
		"Vitimas",			// Multiplayer timed.
		"Vitimas",			// Multiplayer Frag limited.
		"Vitimas",			// Multiplayer last man standing.
		"Vitimas",			// Multiplayer capture the flag.
		"Vitimas",			// Multiplayer Timed capture the flag.
		"Vitimas",			// Multiplayer timed frags.
		"Vitimas",			// Multiplayer last man frag limited.
		"Vitimas",			// Multiplayer last man with time limit.
		"Vitimas",			// Multiplayer last man frag and time limited.
		};
...
extern char* g_apszScoreExplanations[]	=
		{
		"",												// Standard.
		"Maior contagem de corpos em %s",							// Timed.
		"Melhor tempo por matar %d hostis",	// Timed goal.
		"Melhor tempo por capturar a bandeira",	// Timed flag.
		"Melhor tempo por matar %d hostis",	// Goal.
		"Melhor tempo por capturar a bandeira",	// Capture the flag.
		"Maior bandeiras capturadas",						// Checkpoint.
		"Top %d Pontos",								// Multiplayer timed.
		"Top %d Pontos",								// Multiplayer frag.
		"Top %d Pontos",								// Multiplayer last man standing.
		"Top %d Pontos",								// Multiplayer capture the flag.
		"Top %d Pontos",								// Multiplayer Timed capture the flag.
		"Top %d Pontos",								// Multiplayer timed frags.
		"Top %d Pontos",								// Multiplayer last man frag limited.
		"Top %d Pontos",								// Multiplayer last man with time limit.
		"Top %d Pontos",								// Multiplayer last man frag and time limited.
		};
