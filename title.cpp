...
static char*	ms_apszFiles[]	=
	{
	"title/ratingBR.bmp", // Just giving a more fancy name, BR = Brazil -- gabsF
	"title/localizationBrazilianCredits.bmp",// Credits of the Brazilian localization mod -- gabsF
	"title/Logo2.bmp",
	"title/Postal.bmp"
	};				 
